...
class EqualizedLRDense(Layer):
	def __init__(self, units, kernel_initializer=RandomNormal(stddev=RANDOM_NORMAL_STD_DEV, seed=SEED), **kwargs):
	...
	def call(self, inputs):
		return tf.matmul(inputs, self.equalized_weights) * self.equalizer + self.equalized_biases
